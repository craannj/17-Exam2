...
class Triangle(object):
    ...
    def area(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        length_1 = self.a.distance_from(self.b)
        length_2 = self.b.distance_from(self.c)
        length_3 = self.c.distance_from(self.a)
        S_val = (0.5 * (length_1 + length_2 + length_3))
        area = float(math.sqrt(S_val * (S_val - length_1) * (S_val - length_2) * (S_val - length_3)))
        return area
